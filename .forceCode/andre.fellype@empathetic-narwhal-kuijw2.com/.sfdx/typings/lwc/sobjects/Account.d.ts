...
declare module "@salesforce/schema/Account.BillingCity__c" {
  const BillingCity__c:any;
  export default BillingCity__c;
}
declare module "@salesforce/schema/Account.BillingCity__r" {
  const BillingCity__r:any;
  export default BillingCity__r;
}
...
declare module "@salesforce/schema/Account.CNAE__c" {
  const CNAE__c:any;
  export default CNAE__c;
}
declare module "@salesforce/schema/Account.CNAE__r" {
  const CNAE__r:any;
  export default CNAE__r;
}
...
declare module "@salesforce/schema/Account.DocumentNumber__c" {
  const DocumentNumber__c:string;
  export default DocumentNumber__c;
}
